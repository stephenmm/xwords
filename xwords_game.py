...
#sudoku
sudoku = [0 for i in range(225)]
tempNum = [0 for i in range(225)]
tempSp = 0
startH = [0 for i in range(225)]
startV = [0 for i in range(225)]
startB = [0 for i in range(225)]
addH = [0 for i in range(15)]
addV = [0 for i in range(15)]
addB = [0 for i in range(15)]
...
win = Tk()
win.title("xWords Solver")
center_window(win, MainWinWidth, MainWinHeight)

win.lift() #Bring window to the front
...
_ = "#B6FCFA"
color = [
         T,_,_,d,_,_,_,_,_,_,_,d,_,_,T,
         _,D,_,_,_,t,_,_,_,t,_,_,_,D,_,
         _,_,D,_,_,_,d,_,d,_,_,_,D,_,_,
         d,_,_,D,_,_,_,d,_,_,_,D,_,_,d,
         _,_,_,_,D,_,_,_,_,_,D,_,_,_,_,
         _,t,_,_,_,t,_,_,_,t,_,_,_,t,_,
         _,_,d,_,_,_,d,_,d,_,_,_,d,_,_,
         T,_,_,d,_,_,_,D,_,_,_,d,_,_,T,
         _,_,d,_,_,_,d,_,d,_,_,_,d,_,_,
         _,t,_,_,_,t,_,_,_,t,_,_,_,t,_,
         _,_,_,_,D,_,_,_,_,_,D,_,_,_,_,
         d,_,_,D,_,_,_,d,_,_,_,D,_,_,d,
         _,_,D,_,_,_,d,_,d,_,_,_,D,_,_,
         _,D,_,_,_,t,_,_,_,t,_,_,_,D,_,
         T,_,_,d,_,_,_,T,_,_,_,d,_,_,T]




store = [False for i in range(225)]
